...
/**
 initialize the local storage items for favorite list and last input
 */
...
/**
 ...
 {string} value - The value to append to the URL for filtering the results
  
 {Promise} A promise that resolves to the JSON data of the meals
 */
 ...
 * addRemoveToFavList - function to add or remove a meal from the favorite list
 id - The id of the meal to be added or removed
 ...
 * Show details for a specific meal
 itemId - The ID of the meal to show details for
 searchInput - The search input used to fetch the related meals
 */
    ...
    if (mealDetails.meals) {
        ...
        <div class="container remove-top-margin">
            ...
            <div class="header hide">
                <div class="title">
                Are You Craving for Something Tasty
                </div>
            </div>
            <div class="fixed" id="search-bar">
                ...
                <div class="new-search-input">
                    <form onkeyup="showMealList()">
                        <input id="search-input" type="text" placeholder="let's eat....." />
                    </form>
                </div>
            </div>
        </div>
